        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-hover table-striped table-bordered text-center mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('gudang-pakan.pakan-pre-mixing-opname.edit', $data->id) }}" class="btn btn-sm btn-warning text-white">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center">Data Opname Pre-Mixing tidak tersedia</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
