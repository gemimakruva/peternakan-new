...
@section('title', 'Tambah Bahan Pakan Opname')

@section('content_header')
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Tambah Bahan Pakan Opname</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">  
                <li class="breadcrumb-item"><a href="{{ route('gudang-pakan.bahan-pakan-opname.index') }}">Tambah Bahan Pakan Opname</a></li>
...
<div class="mx-1200">
    ...
    <form action="{{ route('gudang-pakan.bahan-pakan-opname.store',) }}" method="post">
        @csrf
        <div class="row">
