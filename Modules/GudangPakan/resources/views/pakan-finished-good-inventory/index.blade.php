...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Inventory Pakan Jadi</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">  
                <li class="breadcrumb-item"><a href="{{ route('gudang-pakan.pakan-finished-good-inventory.index') }}">Pakan Jadi</a></li>
...
<div class="mx-1000">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('gudang-pakan.pakan-finished-good-inventory.index', request()->all()) }}" method="get" class="w-100">                    
