...
use Modules\GudangPakan\Http\Controllers\BahanPakanKeluarController;
use Modules\GudangPakan\Http\Controllers\BahanPakanMasukController;
use Modules\GudangPakan\Http\Controllers\BahanPakanOpnameController;
...
use Modules\GudangPakan\Http\Controllers\PakanFinishedGoodOpnameController;
...
Route::middleware(['auth'])
    ...
    ->group(function () {
        ...
        Route::resource('bahan-pakan-keluar', BahanPakanKeluarController::class)->names('bahan-pakan-keluar');
        Route::resource('bahan-pakan-opname', BahanPakanOpnameController::class)->names('bahan-pakan-opname');
        ...
        Route::resource('pakan-finished-good-opname', PakanFinishedGoodOpnameController::class)->names('pakan-finished-good-opname');
