    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">  
                ...
                <li class="breadcrumb-item active">Telur Masuk</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="mx-1000">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('gudang-telur.telur-masuk.index', request()->all()) }}" method="get" class="w-100">
                <div class="d-flex gap-2 justify-content-start align-items-end">
                    ...
                    <a href="{{ route('gudang-telur.telur-masuk.index') }}" class="btn btn-secondary">
