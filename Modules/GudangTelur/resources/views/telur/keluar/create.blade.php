...
<x-page-header title="Tambah Telur Keluar" :breadcrumbs="['Telur Inventory' => route('gudang-telur.telur-inventory.index'), 'Telur Keluar' => route('gudang-telur.telur-keluar.index'), 'Tambah' => '']" />
@endsection
