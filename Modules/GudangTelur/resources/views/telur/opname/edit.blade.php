...
<x-page-header title="Edit Telur Opname" :breadcrumbs="['Telur Inventory' => route('gudang-telur.telur-inventory.index'), 'Telur Opname' => route('gudang-telur.telur-opname.index'), 'Edit' => '']" />
@endsection
