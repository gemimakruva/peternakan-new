...
@section('title', 'Tambah Jenis Treatment')
...
<div class="container-fluid">
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Jenis Treatment</li>
        </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-md-9 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Jenis Treatment</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('master-data.jenis-treatment.store') }}" method="post" id="form-jenis-treatment">
                    @csrf
