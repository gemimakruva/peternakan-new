...
<div class="mb-4 text-center d-flex flex-column align-items-center pt-3" style="max-width: 1200px;">
    <h2 class="h4 fw-bold text-dark">Metode Treatment</h2>
    <span class="text-muted mb-0" style="max-width: 600px;">
        Halaman untuk menampilkan data metode treatment kandang
    </span>
</div>
@stop
...
<div>
    ...
    <div class="card shadow-sm" style="max-width: 1200px;">
        <div class="card-header text-white d-flex justify-content-between align-items-center"
            ...
            <form action="{{ route('master-data.metode-treatment.index', request()->all()) }}"
                  method="get" class="w-100">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="card-title mb-0">Daftar Metode Treatment</h2>

                    <div class="d-flex" style="gap: .5em">
                        <input type="search"
                               name="search"
                               class="form-control form-control-sm"
                               placeholder="Cari Metode Treatment..."
                        ...
                        <a href="{{ route('master-data.metode-treatment.create') }}"
                           class="btn btn-light btn-sm text-dark"
                           title="Tambah Metode Treatment">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center" style="gap: .5em">
                                ...
                                <a href="{{ route('master-data.metode-treatment.edit', $row->id) }}"
                                ...
                                <form action="{{ route('master-data.metode-treatment.destroy', $row->id) }}"
                                      method="post"
                                      data-nama="{{ $row->nama }}"
                                      class="form-delete">
                                    @csrf
...
<script>
    $(document).on('submit', '.form-delete', function(e) {
        ...
        Swal.fire({
            title: 'Hapus Data?',
            text: "Yakin ingin menghapus metode treatment '" + nama + "'?",
            icon: 'warning',
