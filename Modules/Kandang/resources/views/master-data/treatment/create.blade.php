    ...
    <div class="row justify-content-center">
       ...
       <div class="col-md-8">
          <div class="card shadow-sm border-0">
                <div class="card-body">
                    <form action="{{ route('master-data.jenis-treatment.store') }}"
                     method="post" id="form-flock">
                            @csrf
                            @include('kandang::master-data.treatment._form')
                            <hr class="my-4">
