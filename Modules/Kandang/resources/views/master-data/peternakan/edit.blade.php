...
<div class="mb-4 text-center d-flex flex-column align-items-center">
    <h2 class="h4 fw-bold text-dark"> Edit Data Peternakan</h2>
    <span class="text-muted mb-0" style="max-width: 500px;">
        Form ini digunakan untuk mengubah data Peternakan
    </span>
</div>
@endsection
            ...
            <div class="card shadow-sm border-0" >
                <div class="card-header" style="background-color: #f8f9fa;">
                    <h4 class="card-title m-0 fw-semibold text-secondary">
                        <i class="fas fa-home me-2 text-muted"></i> Form Ubah Data Peternakan
                    </h4>
                </div>

               <div class="card-body d-flex justify-content-center">
                    <form action="{{ route('master-data.peternakan.update', $peternakan) }}" 
                        method="post" 
                        id="form-Peternakan"
