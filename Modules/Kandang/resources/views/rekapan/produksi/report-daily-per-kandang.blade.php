...
<div class="mx-1400">
    ...
    >
        @csrf
        <input type="hidden" name="tipe" value="{{ \Modules\Kandang\Enums\CatatanLaporanTipe::HARIAN_PER_KANDANG->value }}" />
        <input type="hidden" name="kandang_id" value="" />
        ...
        @include('kandang::rekapan.produksi.chart.daily.per-kandang.chart-5-kpi-produksi')
