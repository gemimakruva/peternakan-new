            ...
            datasets: [
                {
                    ...
                    data: @js($rekapanKandang->pluck('akumulasi_mati')),
                    borderWidth: 2,
                    borderColor: '#28a745',
                ...
                },
                {
                    ...
                    data: @js($rekapanKandang->pluck('akumulasi_afkir')),
                    borderWidth: 2,
                    borderColor: '#dc3545',
                ...
                },
                {
                    ...
                    data: @js($rekapanKandang->pluck('akumulasi_mati_afkir')),
                    borderWidth: 2,
                    borderColor: '#fd7e14',
    ...
    new Chart(document.getElementById('kematian-ayam-chart-semua-kandang'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Akumulasi Kematian',
                    data: [@js($rekapanKandang->sum('akumulasi_mati'))],
                    borderWidth: 2,
                    borderColor: '#28a745',
                    backgroundColor: 'rgba(40, 167, 69, 0.1)',
                },
                {
                    label: 'Akumulasi Afkir',
                    data: [@js($rekapanKandang->sum('akumulasi_afkir'))],
                    borderWidth: 2,
                    borderColor: '#dc3545',
                    backgroundColor: 'rgba(220, 53, 69, 0.1)',
                },
                {
                    label: 'Akumulasi Kematian dan Afkir',
                    data: [@js($rekapanKandang->sum('akumulasi_mati_afkir'))],
                    borderWidth: 2,
                    borderColor: '#fd7e14',
                    backgroundColor: 'rgba(253, 126, 20, 0.1)',
                },
    ...
    new Chart(document.getElementById('persentase-kematian-ayam-chart-per-kandang'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Akumulasi Kematian',
                    data: @js($rekapanKandang->pluck('persen_mati')->map(fn($item) => $item*100)),
                    borderWidth: 2,
                    borderColor: '#28a745',
                    backgroundColor: 'rgba(40, 167, 69, 0.1)',
                },
                {
                    label: 'Akumulasi Afkir',
                    data: @js($rekapanKandang->pluck('persen_afkir')->map(fn($item) => $item*100)),
                    borderWidth: 2,
                    borderColor: '#dc3545',
                    backgroundColor: 'rgba(220, 53, 69, 0.1)',
                },
                {
                    label: 'Akumulasi Kematian dan Afkir',
                    data: @js($rekapanKandang->pluck('persen_mati_afkir')->map(fn($item) => $item*100)),
                    borderWidth: 2,
                    borderColor: '#fd7e14',
                    backgroundColor: 'rgba(253, 126, 20, 0.1)',
                },
                {
                    ...
                    data: @js($rekapanKandang->pluck('standar_mati_afkir')->map(fn($item) => $item*100)),
                    borderWidth: 2,
