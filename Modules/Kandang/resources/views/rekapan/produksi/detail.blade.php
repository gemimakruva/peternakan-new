    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">  
                ...
                <li class="breadcrumb-item active">{{ $kandang->nama }} - {{ $tanggal->translatedFormat('l, d F Y') }}</li>
            ...
            <table class="table table-hover table-striped table-bordered text-center mb-0">
                <thead>
                    <tr>
                        ...
                        <x-sort-th class="align-middle" style="min-width: 150px;" label="Flock" name="nama_flock" />
                ...
                <tbody>
                    @forelse($datas as $data)
                        <tr>
                            ...
                            <td class="text-left">{{ $data->nama_flock }}</td>
